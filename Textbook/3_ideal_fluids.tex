...
\]
and to calculate the circulation we'll use a circular path of constant radius $R$ (we don't necessarily need to fix the path, though, in this case, as we'll see).  The dot product in the integral becomes
\[
...
\symbfup{u}  = \left\{
 \begin{array}{l l}
    \Omega s \, \hat{\phi} & \quad \text{if $r < a$}\\
